                ...
                {/* <li>
                  <span className={styles.box_checkinp + ' m-l-0-i'}>
                    <input
                      ...
                      className={styles.inp_check}
                      value="ANGKORCHAT"
                      checked={myForm.adGroup[adGroupIdx].mediaType.includes('ANGKORCHAT')}
                      onChange={(e) => {
                        if (e.target.checked == true) {
                          const newArr = myForm.adGroup[adGroupIdx].mediaType.concat(e.target.value);
                          setValues({
                          ...
                          const newArr = myForm.adGroup[adGroupIdx].mediaType.filter((el) => el !== e.target.value);
                    ...
                    />
                    <label htmlFor="ANGKORCHAT" className={styles.lab_check}>
                      앙코르쳇
                    </label>
                  </span>
                </li> */}
                {/* <li className={styles.reform_item_network + ' m-t-0-i'}>
                  <span className={styles.box_checkinp + ' m-l-0-i'}>
                    <input
                      type="checkbox"
                      name={`adGroup[${adGroupIdx}].mediaType`}
                      ...
                      className={styles.inp_check}
                      value="NETWORK"
                      checked={myForm.adGroup[adGroupIdx].mediaType.includes('NETWORK')}
                      onChange={(e) => {
                        if (e.target.checked == true) {
                          const newArr = myForm.adGroup[adGroupIdx].mediaType.concat(e.target.value);
                          setValues({
                    ...
                    />
                    <label htmlFor="NETWORK" className={styles.lab_check}>
                      네트워크
                    </label>
                  </span>
                </li> */}
