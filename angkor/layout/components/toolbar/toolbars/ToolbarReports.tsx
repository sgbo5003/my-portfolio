    ...
    <div className="d-flex align-items-center overflow-auto">
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex align-items-center ms-3">
          ...
          >
            <AKSVG path="/assets/icons/duotune/general/gen025.svg" className="svg-icon-2 svg-icon-primary" />
          </button>
          ...
          >
            <AKSVG path="/assets/icons/duotune/abstract/abs015.svg" className=" svg-icon-2 svg-icon-gray-400" />
          </button>
        </div>
        {/* end::Actions */}
      </div>
