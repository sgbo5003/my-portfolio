...
const ToolbarExtended: FC = () => {
  ...
  useEffect(() => {
    document.body.setAttribute('data-app-toolbar-fixed', 'true');
  }, []);
    ...
    <>
      <div className="d-flex align-items-center flex-shrink-0 me-5">
        ...
        <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Invite a team member">
          <a href="#" className="btn btn-sm btn-icon">
            <AKSVG path="/assets/icons/duotune/general/gen035.svg" className="svg-icon-2hx svg-icon-success" />
          </a>
        </div>
      </div>
      {/* end::Button */}
      ...
      <div className="d-flex align-items-center overflow-auto">
        ...
        <div className="position-relative my-1">
          <AKSVG
            path="/assets/icons/duotune/general/gen021.svg"
        ...
        <div className="d-flex align-items-center">
          ...
          >
            <AKSVG path="/assets/icons/duotune/general/gen025.svg" className="svg-icon-3 svg-icon-primary" />
          </button>
          ...
          >
            <AKSVG path="/assets/icons/duotune/general/gen010.svg" className="svg-icon-3 svg-icon-gray-400" />
          </button>
        </div>
        {/* end::Actions */}
      </div>
