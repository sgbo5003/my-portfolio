          ...
          <div className="d-flex flex-shrink-0">
            ...
            <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Add a team member">
              <a href="#" className="btn btn-sm btn-icon btn-active-color-success">
                <AKSVG path="/assets/icons/duotune/general/gen035.svg" className="svg-icon-2x" />
              </a>
            </div>
            {/* end::Button */}
            ...
            <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Create new account">
              <a href="#" className="btn btn-sm btn-icon btn-active-color-success">
                <AKSVG path="/assets/icons/duotune/general/gen037.svg" className="svg-icon-2x" />
              </a>
            </div>
            {/* end::Button */}
            ...
            <div data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Invite friends">
              <a href="#" className="btn btn-sm btn-icon btn-active-color-success">
                <AKSVG path="/assets/icons/duotune/general/gen023.svg" className="svg-icon-2x" />
              </a>
            </div>
            {/* end::Button */}
          </div>
