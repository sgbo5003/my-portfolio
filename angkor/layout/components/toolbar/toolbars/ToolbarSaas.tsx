    ...
    <div className="d-flex align-items-center gap-2">
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex align-items-center ps-4">
          <div id="app_toolbar_slider" className="noUi-target noUi-target-success w-75px w-xxl-150px noUi-sm"></div>

          <span
            id="app_toolbar_slider_value"
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="d-flex">
          ...
          <a
            ...
            title="Add new page"
          >
            <AKSVG path="/assets/icons/duotune/files/fil003.svg" className="svg-icon-2x" />
          </a>
          {/* end::Action */}
          ...
          >
            <AKSVG path="/assets/icons/duotune/files/fil005.svg" className="svg-icon-2x" />
          </a>
          {/* end::Action */}
          ...
          >
            <AKSVG path="/assets/icons/duotune/files/fil024.svg" className="svg-icon-2x" />
          </a>
          {/* end::Action */}
        </div>
        {/* end::Actions */}
