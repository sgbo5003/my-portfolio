    ...
    <div className="d-flex align-items-center gap-2 gap-lg-3">
      {/* {config.app?.toolbar?.filterButton && (
        <div className="m-0">
          ...
          >
            <AKSVG path="/assets/icons/duotune/general/gen031.svg" className="svg-icon-6 svg-icon-muted me-1" />
            Filter
          </a>
          <Dropdown1 />
        </div>
      ...
      {config.app?.toolbar?.daterangepickerButton && (
        ...
        >
          ...
          <AKSVG path="/assets/icons/duotune/general/gen014.svg" className="svg-icon-1 ms-2 me-0" />
        </div>
      )}
      ...
      {config.app?.toolbar?.primaryButton && (
        <a
          ...
          data-bs-target="#modal_create_app"
        >
          Create
        </a>
      )} */}
