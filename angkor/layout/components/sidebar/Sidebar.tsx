...
const Sidebar = () => {
  ...
  return (
    <div id="app_sidebar" className={clsx('app-sidebar', config.app?.sidebar?.default?.class)}>
      <SidebarLogo />
      <SidebarMenu />
      {/* <SidebarFooter /> */}
    </div>
...
const updateDOM = (config: ILayout) => {
  ...
  document.body.setAttribute('data-app-sidebar-fixed', config.app?.sidebar?.default?.fixed?.desktop?.toString() || '');
