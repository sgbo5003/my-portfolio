...
class ToggleComponent {
  ...
  constructor(_element: HTMLElement, options: ToggleOptions) {
    ...
    const elementTargetAttr = this.element.getAttribute('data-toggle-target');
    if (elementTargetAttr) {
      this.target = document.querySelector(elementTargetAttr);
    }
    const elementToggleAttr = this.element.getAttribute('data-toggle-state');
    this.state = elementToggleAttr || '';
    const elementModeAttr = this.element.getAttribute('data-toggle-mode');
    this.mode = elementModeAttr || '';
    this.attribute = 'data-' + this.element.getAttribute('data-toggle-name');
  ...
  private _toggle = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'ak.toggle.change');
    ...
    EventHandlerUtil.trigger(this.element, 'ak.toggle.changed');
    return this;
  };
  ...
  private _enable = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'ak.toggle.enable');
    ...
    EventHandlerUtil.trigger(this.element, 'ak.toggle.enabled');
    return this;
  };
  ...
  private _disable = () => {
    ...
    EventHandlerUtil.trigger(this.element, 'ak.toggle.disable');
    ...
    EventHandlerUtil.trigger(this.element, 'ak.toggle.disabled');
    return this;
  };
  ...
  public static reinitialization = () => {
    ToggleComponent.createInstances('[data-toggle]');
  };
