...
class FeedbackComponent {
  ...
  ///////////////////////
  public show = () => {
    if (EventHandlerUtil.trigger(this.element, 'ak.feedback.show') === false) {
      return;
    }
    ...
    EventHandlerUtil.trigger(this.element, 'ak.feedback.shown');

    return this;
  };

  public hide = () => {
    if (EventHandlerUtil.trigger(this.element, 'ak.feedback.hide') === false) {
      return;
    }
    ...
    this.shown = false;
    EventHandlerUtil.trigger(this.element, 'ak.feedback.hidden');
    return this;
  };
