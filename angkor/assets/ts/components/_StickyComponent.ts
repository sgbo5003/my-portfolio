    ...
    if (reverse === true) {
      ...
      if (st > offsetNum && this.lastScrollTop < st) {
        ...
        if (this.eventTriggerState === true) {
          EventHandlerUtil.trigger(this.element, 'ak.sticky.on');
          EventHandlerUtil.trigger(this.element, 'ak.sticky.change');
        ...
        if (this.eventTriggerState === false) {
          EventHandlerUtil.trigger(this.element, 'ak.sticky.off');
          EventHandlerUtil.trigger(this.element, 'ak.sticky.change');
