...
class DrawerComponent {
  ...
  private _toggle = () => {
    if (EventHandlerUtil.trigger(this.element, 'ak.drawer.toggle') === false) {
      return;
    }
    ...
    EventHandlerUtil.trigger(this.element, 'ak.drawer.toggled');
  };

  private _hide = () => {
    if (EventHandlerUtil.trigger(this.element, 'ak.drawer.hide') === false) {
      return;
    }
    ...
    EventHandlerUtil.trigger(this.element, 'ak.drawer.after.hidden');
  };

  private _show = () => {
    if (EventHandlerUtil.trigger(this.element, 'ak.drawer.show') === false) {
      return;
    }
    ...
    EventHandlerUtil.trigger(this.element, 'ak.drawer.shown');
  };
