...
class SearchComponent {
  ...
  private handlers(): void {
    ...
    if (this.menuObject) {
      ...
      if (this.toggleElement) {
        ...
        this.menuObject.on('ak.menu.dropdown.show', function () {
          // @ts-ignore
        ...
        this.menuObject.on('ak.menu.dropdown.hide', function () {
          // @ts-ignore
          if (isVisibleElement(context.toggleElement)) {
            // @ts-ignore
      ...
      this.menuObject.on('ak.menu.dropdown.shown', function () {
        // @ts-ignore
  ...
  public search = () => {
    if (!this.processing) {
      ...
      EventHandlerUtil.trigger(this.element, 'ak.search.process', this);
    }
  };
  ...
  // Clear
  public clear = () => {
    if (EventHandlerUtil.trigger(this.element, 'ak.search.clear') === false) {
      return;
    }
    ...
    EventHandlerUtil.trigger(this.element, 'ak.search.cleared');
  };
